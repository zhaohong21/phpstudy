...
echo "<!DOCTYPE html>\n<html><head><title>An Example Form 2</title>";
    ...
    <script>
        ...
        function validateUsername(field) {
            if (field == "")
                ...
                return "Only a-z,A-Z,0-9,_and- allowed in Usernames.\\n"
            return ""
        }
        function validatePassword(field) {
            if (field == "") return "No Password was entered.\\n"
            else if (field.length<6) return "Password must be at least 6 characters.\\n"
            else if (!/[a-z]/.test(field) || !/[A-Z]/.test(field) || !/[0-9]/.test(field)) return "Password reuire one each of a-z,A-Z,0-9.\\n"
            return ""
        }
...
function validate_username($field)
{
    if ($field == "")
        ...
        return "Only a-z,A-Z,0-9,_and- allowed in Usernames.<br>";
    return "";
}
function validate_password($field)
{
    if ($field == "") return "No Password was entered.<br>";
        ...
        return "Password reuire one each of a-z,A-Z,0-9.<br>";
    return "";
}
function validate_age($field)
{
    if ($field == "") return "No Age was entered.<br>";
    else if ($field < 18 || $field > 110) return "Age must be between 18 and 110.<br>";
    return"";
}
